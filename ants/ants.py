...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        while curr_place:
            if self.min_range <= distance <= self.max_range and not curr_place.is_hive and curr_place.bees:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        place = self.place
        total_damage = amount if self.health > amount else amount + self.damage
        ...
        while place:
            if place.ant:
                ...
                if ant.is_container and ant.ant_contained:
                    if not ant.ant_contained.buffed:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        for bee in self.place.bees:
            res[bee] = 0
        curr_place = self.place.entrance
        dist = 1
        while curr_place != None:
            ...
            if curr_ant:
                ...
                if curr_ant.is_container:
                    res[curr_ant.ant_contained] = dist
            curr_bees = curr_place.bees
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        return self.damage - distance * 0.25 - self.insects_shot / 16
        # END Problem Optional 2
