...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 1
        frame = self
        curr_bindings = self.bindings
        while frame.parent != None and symbol not in curr_bindings:
            frame, curr_bindings = frame.parent, frame.parent.bindings
        if symbol in curr_bindings:
            return curr_bindings[symbol]
        # END PROBLEM 1
    ...
    def make_child_frame(self, formals, vals):
        ...
        while formals != nil and formals.rest != nil:
