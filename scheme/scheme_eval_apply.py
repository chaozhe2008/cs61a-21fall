...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        # BEGIN PROBLEM 9
        "*** YOUR CODE HERE ***"
        defined_frame = procedure.env
        new_frame = defined_frame.make_child_frame(procedure.formals, args)
...
def eval_all(expressions, env):
    ...
    # BEGIN PROBLEM 6
    curr = expressions
    while curr != nil and curr.rest != nil:
        scheme_eval(curr.first, env)
        curr = curr.rest
    return None if curr == nil else scheme_eval(curr.first, env)
