...
def berry_finder(t):
    ...
    """
    res = False
    if t[0] == 'berry' or (is_leaf(t) and t[0] == 'berry'):
        return True
    else:
        for s in branches(t):
            res = res or berry_finder(s)
    return res
...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        sub = [sprout_leaves(t, leaves) for t in branches(t)]
